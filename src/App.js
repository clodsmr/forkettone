      ...
      <Container fluid style={{ padding: "0px" }}>
        <Row className="firstRow">
          ...
          <Col xs={12} md={6} className="d-flex flex-column-reverse">
            <img
              src="https://i.ibb.co/nfSktkw/Group-5.png"
              alt="Group-5"
              border="0"
        ...
        <Row>
          <Col xs={0} md={6}>
            <img
              src="https://i.ibb.co/xmnqDFg/image-1.png"
              alt="image-1"
              border="0"
            />
          </Col>
        ...
        <Container className="green-row" fluid style={{ position: "relative" }}>
          ...
          <Container>
            <Row>
              <Col xs={12} md={7} style={{ paddingTop: "15vh", paddingBottom: "20vh", paddingLeft: "10vw" }}>
                <p className="sett36">
              ...
              <Col xs={0} md={5} className="sopraFooter ">
              <img
